...
/* Composant qui fait une requete à l'API open food fact en fonction du produit recherché avec un meilleur nutriscore
useHistory pour prendre en compte la dernière recherche de l'utilisateur*/
